...
const NationalSportsOrigenProdactScreen = ({navigation, route}) => {
  ...
  ////////////////////////////////
  let baseUrl = `https://astounding-exalted-ecstasy.space/xFH9w8bd?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
...
export default NationalSportsOrigenProdactScreen;
